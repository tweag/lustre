...
struct lnet_net {
	...
	/*
	 * network global peer timeout value for peers going over this network
	 */
	int			net_peer_timeout;

	/* # tx credits */
	int			net_maxtxcredits;

	/* # per-peer send credits */
	int			net_peertxcredits;

	/* # per-peer router buffer credits */
	int			net_peerrtrcredits;
